...
tempo=parseFloat(prompt("Quanto tempo de viagem foi gasto?"))
velocidade=parseFloat(prompt("Qual foi a velocidade média?"))
distancia=tempo*velocidade
litros=distancia/12


alert("A sua velocidade média foi de "+velocidade+"Km/h, seu tempo gasto foi de "+tempo+" percorrendo: "+distancia+" gastando: "+litros+" de gasolina.")